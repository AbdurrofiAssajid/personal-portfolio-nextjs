...
export const ContainerScroll = ({
  ...
  const translate = useTransform(scrollYProgress, [0, 0.5], [100, 0]);
...
export const Card = ({
  ...
  return (
    ...
    >
      <div className="relative h-full w-full overflow-hidden rounded-2xl bg-gray-100 dark:bg-black md:rounded-2xl md:p-4">
